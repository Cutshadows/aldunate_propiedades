        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <label for="busqueda" class="small">Tramo de Valor : </label>
                    <select name="" id="">
                        <option value=""></option>
                        <option value=""></option>
                        <option value=""></option>
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <label for="busqueda" class="small">Comunas</label>
                    <select name="" id="">
                        <option value=""></option>
                        <option value=""></option>
                        <option value=""></option>
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <label for="busqueda" class="small">Venta</label>
                    <select name="" id="">
                        <option value=""></option>
                        <option value=""></option>
                        <option value=""></option>
